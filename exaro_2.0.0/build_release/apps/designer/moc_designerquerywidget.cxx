...
void Report::DesignerQueryWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        DesignerQueryWidget *_t = static_cast<DesignerQueryWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData Report::DesignerQueryWidget::staticMetaObjectExtraData = {
...
const QMetaObject Report::DesignerQueryWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Report__DesignerQueryWidget,
      qt_meta_data_Report__DesignerQueryWidget, &staticMetaObjectExtraData }
};
