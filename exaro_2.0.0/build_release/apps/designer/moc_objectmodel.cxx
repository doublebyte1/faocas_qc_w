...
#include "../../../apps/designer/objectmodel.h"
...
static const char qt_meta_stringdata_ObjectModel[] = {
    "ObjectModel\0"
};
...
const QMetaObjectExtraData ObjectModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ObjectModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_ObjectModel,
      qt_meta_data_ObjectModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ObjectModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ObjectModel))
