...
#include "../../../../../plugins/report/bands/title/title.h"
...
const QMetaObject Title::staticMetaObject = {
    { &Report::BandInterface::staticMetaObject, qt_meta_stringdata_Title,
...
void *Title::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ro.bigendian.Report.ItemInterface/1.0"))
        return static_cast< Report::ItemInterface*>(const_cast< Title*>(this));
