...
#include "../../../../../plugins/report/bands/pageFooter/pagefooter.h"
...
const QMetaObject PageFooter::staticMetaObject = {
    { &Report::BandInterface::staticMetaObject, qt_meta_stringdata_PageFooter,
...
void *PageFooter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ro.bigendian.Report.ItemInterface/1.0"))
        return static_cast< Report::ItemInterface*>(const_cast< PageFooter*>(this));
