...
#include "../../../../../plugins/report/bands/overlay/overlay.h"
...
const QMetaObject Overlay::staticMetaObject = {
    { &Report::BandInterface::staticMetaObject, qt_meta_stringdata_Overlay,
...
void *Overlay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ro.bigendian.Report.ItemInterface/1.0"))
        return static_cast< Report::ItemInterface*>(const_cast< Overlay*>(this));
