...
#include "../../../../../plugins/report/items/rectangle/rectangle.h"
...
static const uint qt_meta_data_Rectangle[] = {
 ...
 // properties: name, type, flags
      16,   10, ((uint)QMetaType::QReal << 24) | 0x00095103,
      24,   10, ((uint)QMetaType::QReal << 24) | 0x00095103,

       0        // eod
};

static const char qt_meta_stringdata_Rectangle[] = {
    "Rectangle\0qreal\0xRadius\0yRadius\0"
};
...
const QMetaObject Rectangle::staticMetaObject = {
    { &Report::ItemInterface::staticMetaObject, qt_meta_stringdata_Rectangle,
...
void *Rectangle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ro.bigendian.Report.ItemInterface/1.0"))
        return static_cast< Report::ItemInterface*>(const_cast< Rectangle*>(this));
...
int Rectangle::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_id < 0)
     ...
     if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< qreal*>(_v) = xRadius(); break;
        case 1: *reinterpret_cast< qreal*>(_v) = yRadius(); break;
        }
        _id -= 2;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setXRadius(*reinterpret_cast< qreal*>(_v)); break;
        case 1: setYRadius(*reinterpret_cast< qreal*>(_v)); break;
        }
        _id -= 2;
