...
#include "../../../../plugins/report/page/page.h"
...
const QMetaObject Page::staticMetaObject = {
    { &PageInterface::staticMetaObject, qt_meta_stringdata_Page,
...
void *Page::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ro.bigendian.Report.PageInterface/1.0"))
        return static_cast< Report::PageInterface*>(const_cast< Page*>(this));
    return PageInterface::qt_metacast(_clname);
}

int Page::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = PageInterface::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
