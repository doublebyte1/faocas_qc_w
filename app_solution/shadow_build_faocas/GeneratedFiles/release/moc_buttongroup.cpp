...
void ButtonGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->buttonReleased((*reinterpret_cast< int(*)>(_a[1]))); break;
...
const QMetaObjectExtraData ButtonGroup::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ButtonGroup::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ButtonGroup,
      qt_meta_data_ButtonGroup, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ButtonGroup::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ButtonGroup))
...
// SIGNAL 0
void ButtonGroup::buttonClicked(int _t1)
{
...
// SIGNAL 1
void ButtonGroup::buttonReleased(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void ButtonGroup::buttonPressed(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
static const char qt_meta_stringdata_RadioDelegate[] = {
    "RadioDelegate\0\0commitMyData()\0"
};
...
void RadioDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        RadioDelegate *_t = static_cast<RadioDelegate *>(_o);
        switch (_id) {
        case 0: _t->commitMyData(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject RadioDelegate::staticMetaObject = {
    { &QSqlRelationalDelegate::staticMetaObject, qt_meta_stringdata_RadioDelegate,
