...
void XmlTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        XmlTable *_t = static_cast<XmlTable *>(_o);
        switch (_id) {
        case 0: _t->doRollbackImport(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
