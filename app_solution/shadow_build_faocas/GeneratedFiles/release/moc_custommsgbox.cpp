...
#include "../../../app_new/custommsgbox.h"
...
void CustomMsgBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData CustomMsgBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CustomMsgBox::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CustomMsgBox,
      qt_meta_data_CustomMsgBox, &staticMetaObjectExtraData }
};
