...
void FrmPrjPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData FrmPrjPage::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FrmPrjPage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FrmPrjPage,
      qt_meta_data_FrmPrjPage, &staticMetaObjectExtraData }
};
