...
void FrmRegions::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        FrmRegions *_t = static_cast<FrmRegions *>(_o);
        switch (_id) {
        case 0: _t->Apply(); break;
        case 1: _t->reload(); break;
        case 2: _t->treeEdited(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData FrmRegions::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FrmRegions::staticMetaObject = {
    { &SecondaryFrm::staticMetaObject, qt_meta_stringdata_FrmRegions,
      qt_meta_data_FrmRegions, &staticMetaObjectExtraData }
};
