...
#include "../../../app_new/frmvesseltype.h"
...
void FrmVesselType::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        FrmVesselType *_t = static_cast<FrmVesselType *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData FrmVesselType::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FrmVesselType::staticMetaObject = {
    { &PreviewTab::staticMetaObject, qt_meta_stringdata_FrmVesselType,
      qt_meta_data_FrmVesselType, &staticMetaObjectExtraData }
};
