...
#include "../../../app_new/frmchangereasons.h"
...
void FrmChangeReasons::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData FrmChangeReasons::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FrmChangeReasons::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FrmChangeReasons,
      qt_meta_data_FrmChangeReasons, &staticMetaObjectExtraData }
};
