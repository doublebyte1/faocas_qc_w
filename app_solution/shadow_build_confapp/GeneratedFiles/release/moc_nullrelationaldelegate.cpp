/****************************************************************************
** Meta object code from reading C++ file 'nullrelationaldelegate.h'
**
...
#include "../../../app_new/nullrelationaldelegate.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'nullrelationaldelegate.h' doesn't include <QObject>."
...
void NullRelationalDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData NullRelationalDelegate::staticMetaObjectExtraData = {
...
const QMetaObject NullRelationalDelegate::staticMetaObject = {
    { &QSqlRelationalDelegate::staticMetaObject, qt_meta_stringdata_NullRelationalDelegate,
      qt_meta_data_NullRelationalDelegate, &staticMetaObjectExtraData }
};
